...
# USAGE
# ============================================================
# This is the only block you need to run.
#
# Step 1:
#   Run the best anchor-attention exposure model.
#
# Step 2:
#   Apply post-hoc calibration:
#       global scale
#       event-specific scale
#       high-exposure scale
#       funnel constraint: total >= buy_box >= in_stock
#
# Step 3:
#   Use exposure_hat_for_demand_calib in the downstream demand model.
# ============================================================

# 1. Best anchor-attention exposure model
result_best = run_best_exposure_anchor_attention(
    data_raw1=data_raw1,
    scot_df=scot_df,
    n_asins=5000,
...
# 2. Post-hoc calibration on the best anchor-attention output
calib_result = run_posthoc_calibration_on_best_anchor_attention(
    result_best=result_best,
    data_raw1=data_raw1,
    mode="upper_bound",      # first check upper bound; then try "time_split"
    event_window_weeks=2,
    high_q=0.80,
    clip_scale=(0.70, 1.80),
    shrink_k=5000,
...
# 3. Calibrated exposure predictions for the demand model
exposure_hat_for_demand_calib = calib_result["exposure_hat_for_demand_calib"]

# Optional: more realistic calibration check
# calib_result_ts = run_posthoc_calibration_on_best_anchor_attention(
#     result_best=result_best,
#     data_raw1=data_raw1,
#     mode="time_split",
#     event_window_weeks=2,
...
#     shrink_k=5000,
# )
# exposure_hat_for_demand_calib_ts = calib_result_ts["exposure_hat_for_demand_calib"]
