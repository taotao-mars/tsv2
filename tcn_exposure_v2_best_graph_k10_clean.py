...
def run_exposure_v2(
    ...
    print("\n" + "=" * 100)
    print("EXPOSURE MODEL V2: SINGLE-HEAD DIRECT + D SEASONALITY + MULTI-CHANNEL NEIGHBOR GRAPH K=10")
    print("=" * 100)
...
def run_exposure_v2_rolling(
    ...
    print("\n" + "=" * 100)
    print("EXPOSURE MODEL V2: ROLLING BACKTEST")
    print("=" * 100)
...
def summarize_gl_diagnostics(gl_diag, min_asins=30):
    ...
    # Compact version: return summary without verbose printing.
    return summary
...
# ============================================================
# CURRENT USAGE: best graph K=10 version, no Block-AR
# ============================================================
# %run -i tcn_exposure_v2_best_graph_k10_clean.py
#
# result_graph = run_exposure_v2_final_scot_5000(
#     data_raw1=data_raw1,
#     scot_df=scot_df,
#     history=13,
#     horizon=20,
...
# )
#
# pred_df = result_graph["forecast_df"]
# exposure_hat_for_demand = result_graph["exposure_hat_for_demand"]
#
# # Optional save:
# # pred_df.to_csv("exposure_graph_k10_pred_df.csv", index=False)
# # exposure_hat_for_demand.to_csv("exposure_hat_for_demand_graph_k10.csv", index=False)
#
# # Demand connection:
